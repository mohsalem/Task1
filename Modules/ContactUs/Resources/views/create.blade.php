...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form class="text-center"  style="color: #757575;"method="post" action="/contactus/create">

            @csrf
            @foreach($fields as $field)

            <div class="md-form mt-3">
                <input type="text" required="true" name="{{$field->id}}" id="materialContactFormName" class="form-control">
